...
import { stripePaymentServiceSchema, stripeSessionSchema } from './payment.validation'
...
router.get('/' ,authoRization(USER_ROLE.admin) , PaymentController.getAllPeymentList)
